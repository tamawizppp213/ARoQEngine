...
namespace gm::simd::avx
{
	...
	*----------------------------------------------------------------------*/
	...
	GLOBAL_CONST Vector256 VECTOR_256D_MASK_SIGN         = { { ~(gu::uint64(1) << 63), ~(gu::uint64(1) << 63), ~(gu::uint64(1) << 63), ~(gu::uint64(1) << 63) } };
	GLOBAL_CONST Vector256 VECTOR_256U_MASK_ABS          = { {  ~gu::uint64(0), ~gu::uint64(0), ~gu::uint64(0), gu::uint64(0)  } };
	GLOBAL_CONST Vector256 VECTOR_256U_NEGATIVE_ONE_MASK = { { 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF } };
	...
	GLOBAL_CONST Vector256 VECTOR_256U_MASK_X            = { { 0xFFFFFFFFFFFFFFFF, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000  } };
	GLOBAL_CONST Vector256 VECTOR_256U_MASK_Y            = { { 0x0000000000000000, 0xFFFFFFFFFFFFFFFF, 0x0000000000000000, 0x0000000000000000  } };
	GLOBAL_CONST Vector256 VECTOR_256U_MASK_Z            = { { 0x0000000000000000, 0x0000000000000000, 0xFFFFFFFFFFFFFFFF, 0x0000000000000000  } };
	GLOBAL_CONST Vector256 VECTOR_256U_MASK_W            = { { 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0xFFFFFFFFFFFFFFFF  } };
	GLOBAL_CONST Vector256 VECTOR_256U_MASK_XYZ          = { { 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0x0000000000000000  } };
