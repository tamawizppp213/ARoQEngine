...
namespace rhi::core
{
	...
	*****************************************************************************/
	...
	public:
		...
		**                Public Function
		*****************************************************************************/
		virtual void Load(const gu::wstring& filePath, const gu::SharedPointer<RHICommandList>& commandList) = 0;

		virtual void Save(const gu::wstring& filePath, const gu::SharedPointer<RHICommandList>& commandList, const gu::SharedPointer<RHICommandQueue>& commandQueue) = 0;
	...
	protected:
		...
		*****************************************************************************/
		...
		explicit GPUTexture(const gu::SharedPointer<RHIDevice>& device, [[maybe_unused]]const gu::wstring& name = L"Texture") : core::GPUResource(device) {};
		explicit GPUTexture(const gu::SharedPointer<RHIDevice>& device, const GPUTextureMetaData& metaData, [[maybe_unused]] const gu::wstring& name): core::GPUResource(device), _metaData(metaData) {};
