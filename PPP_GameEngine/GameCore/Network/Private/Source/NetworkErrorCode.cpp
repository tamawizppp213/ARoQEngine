...
void NetworkException::Log()
{
	...
	switch (_errorCode)
	{
		...
		case WSAEACCES         : throw std::runtime_error("Access denied.");
		...
		case WSAEMSGSIZE       : throw std::runtime_error("The message is too large.");
		...
		case WSAENETRESET      : throw std::runtime_error("Network dropped connection on reset");
		...
		case WSAENOTCONN       : throw std::runtime_error("Socket is not connected.");
		case WSAESHUTDOWN      : throw std::runtime_error("Socket is shut down.");
		case WSAETIMEDOUT      : throw std::runtime_error("Connection request timed out.");
		case WSAEHOSTUNREACH   : throw std::runtime_error("There is no path to the host.");
