...
bool ::is_cube_map(DDS_TEXTURE* texture)
{
	if (!texture) { return false; }
	return texture->is_cubemap == 1;
}

bool ::is_volume_map(DDS_TEXTURE* texture)
{
	if (!texture) { return false; }
	return texture->is_volumemap == 1;
}
