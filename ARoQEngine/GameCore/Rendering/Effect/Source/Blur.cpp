...
void GaussianBlur::PrepareResourceView()
{
	...
	//  xblur
	{
		const auto dstData     = GPUTextureMetaData::Texture2D(Screen::GetScreenWidth() / 2, Screen::GetScreenHeight(), format, 1, TextureCreateFlags::UnorderedAccess | TextureCreateFlags::RenderTargetable);
	...
	// yblur
	{
		const auto dstData         = GPUTextureMetaData::Texture2D(Screen::GetScreenWidth() / 2, Screen::GetScreenHeight() / 2, format, 1, TextureCreateFlags::UnorderedAccess | TextureCreateFlags::RenderTargetable);
		const auto destTexture     = device->CreateTexture(dstData);
	...
	// finalblur
	{
		const auto dstData     = GPUTextureMetaData::Texture2D(Screen::GetScreenWidth()    , Screen::GetScreenHeight()    , format, 1, TextureCreateFlags::UnorderedAccess | TextureCreateFlags::RenderTargetable);
		const auto destTexture = device->CreateTexture(dstData);
