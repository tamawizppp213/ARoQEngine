...
namespace platform::windows
{
	...
	*****************************************************************************/
	...
	public:
		...
		*************************************************************************/
		virtual gu::SharedPointer<core::file::IFileHandle> OpenRead(const gu::tchar* fileName, const bool allowWrite = false, const bool useAsync = false) override;
		...
		*  @return    IFileHandle* ファイルのハンドル
		*************************************************************************/
		virtual gu::SharedPointer<core::file::IFileHandle> OpenWrite(const gu::tchar* fileName, const bool append = false, const bool allowRead = false, const bool useAsync = false) override;
		...
		*************************************************************************/
		virtual bool FileExists(const gu::tchar* filePath) const override;
		...
		*  @return    bool ファイルが存在する場合, trueを返します.
		*************************************************************************/
		virtual bool DirectoryExists(const gu::tchar* directory) const override;
		...
		*************************************************************************/
		virtual bool CreateDirectory(const gu::tchar* directory) const override;
		...
		*************************************************************************/
		virtual bool DeleteDirectory(const gu::tchar* directory) const override;
		...
		*************************************************************************/
		virtual bool DeleteFile(const gu::tchar* filePath) const override;
		...
		*************************************************************************/
		virtual bool CopyFile(const gu::tchar* from, const gu::tchar* to, const bool overwrite) const override;
		...
		*************************************************************************/
		virtual bool MoveFile(const gu::tchar* from, const gu::tchar* to) const override;
		...
		*************************************************************************/
		virtual bool IsReadOnly(const gu::tchar* filePath) const override;
		...
		*************************************************************************/
		virtual platform::core::file::LinkType LinkType(const gu::tchar* path) const override;

		/*!**********************************************************************
		*  @brief     指定したファイルパスの拡張子を取得します
		*  @param[in] const tchar* ファイルパス
		*  @return    const tstring* 拡張子です. (見つからない場合はnullptrを返します)
		*************************************************************************/
		virtual gu::tstring GetExtension(const gu::tchar* filePath) const override;
		...
		*************************************************************************/
		virtual gu::tstring GetDirectory(const gu::tchar* filePath) const override;
		...
		*  @return    bool
		*************************************************************************/
		virtual bool CreateHardLink(const gu::tchar* sourcePath, const gu::tchar* newHardLinkPath) const override;
		...
		*  @return    bool
		*************************************************************************/
		virtual bool CreateSymbolicLink(const gu::tchar* sourcePath, const gu::tchar* newSymbolicLinkPath) const override;
		#pragma endregion 
