...
namespace platform::core
{
	...
	*****************************************************************************/
	...
	public:
		...
		*************************************************************************/
		virtual gu::SharedPointer<file::IFileHandle> OpenRead(const gu::tstring& fileName, const bool allowWrite = false, const bool useAsync = false) = 0;
		...
		*  @return    IFileHandle* ファイルのハンドル
		*************************************************************************/
		virtual gu::SharedPointer<file::IFileHandle> OpenWrite(const gu::tstring& fileName, const bool append = false, const bool allowRead = false, const bool useAsync = false) = 0;
		...
		*************************************************************************/
		virtual bool FileExists(const gu::tstring& filePath) const = 0;
		...
		*  @return    bool ファイルが存在する場合, trueを返します.
		*************************************************************************/
		virtual bool DirectoryExists(const gu::tstring& directory) const = 0;
		...
		*************************************************************************/
		virtual bool CreateDirectory(const gu::tstring& directory) const = 0;
		...
		*************************************************************************/
		virtual bool DeleteDirectory(const gu::tstring& directory) const = 0;
		...
		*************************************************************************/
		virtual bool DeleteFile(const gu::tstring& filePath) const = 0;

		/*!**********************************************************************
		*  @brief     ファイルをコピーします
		*  @param[in] const gu::tstring& コピー前のファイルパス
		*  @param[in] const gu::tstring& コピー後のファイルパス
		*  @param[in] const bool   上書きを許可するかを設定します
		*  @return    bool ファイルがコピーできた場合にtrueを返します
		*************************************************************************/
		virtual bool CopyFile(const gu::tstring& from, const gu::tstring& to, const bool overwrite) const = 0;

		/*!**********************************************************************
		*  @brief     ファイルを移動します
		*  @param[in] const gu::tstring& 移動前のファイルパス
		*  @param[in] const gu::tstring& 移動後のファイルパス
		*  @return    bool ファイルが移動できた場合にtrueを返します
		*************************************************************************/
		virtual bool MoveFile(const gu::tstring& from, const gu::tstring& to) const = 0;
		...
		*************************************************************************/
		virtual bool IsReadOnly(const gu::tstring& filePath) const = 0;

		/*!**********************************************************************
		*  @brief     ファイル, もしくはディレクトリのリンク(参照)の種類を返します.
		*  @param[in] const gu::tstring& ファイルパス, もしくはディレクトリ
		*  @return    file::LinkType リンクの種類
		*************************************************************************/
		virtual file::LinkType LinkType(const gu::tstring& path) const = 0;
		...
		*************************************************************************/
		virtual gu::tstring GetExtension(const gu::tstring& filePath) const = 0;
		...
		*************************************************************************/
		virtual gu::tstring GetDirectory(const gu::tstring& filePath) const = 0;

		/*!**********************************************************************
		*  @brief     ディレクトリを取り去ってファイル名を取得します
		*  @param[in] const gu::tstring& ディレクトリを含めたファイル名
		*  @return    gu::tstring
		*************************************************************************/
		virtual gu::tstring GetFileName(const gu::tstring& filePath) const = 0;
		...
		*  @param[in] const gu::tstring& リンクを行いたい元のファイルパス
		*  @param[in] const gu::tstring& リンクを作成したいファイルパス
		*  @return    bool
		*************************************************************************/
		virtual bool CreateHardLink(const gu::tstring& sourcePath, const gu::tstring& newHardLinkPath) const = 0;
		...
		*  @return    bool
		*************************************************************************/
		virtual bool CreateSymbolicLink(const gu::tstring& sourcePath, const gu::tstring& newSymbolicLinkPath) const = 0;
		#pragma endregion 
