	...
	*****************************************************************************/
	...
	public:
		...
		*************************************************************************/
		...
		/*!**********************************************************************
		*  @brief     先頭の要素を参照の形で返します
		*  @param[in] void
		*  @return    ElementType& 先頭の要素
		*************************************************************************/
		__forceinline       ElementType& Front()       {return _data;}

		/*!**********************************************************************
		*  @brief     先頭の要素をconst参照の形で返します
		*  @param[in] void
		*  @return    const ElementType& 先頭の要素
		*************************************************************************/
		__forceinline const ElementType& Front() const { return _data; }

		/*!**********************************************************************
		*  @brief     末尾の要素を参照の形で返します
		*  @param[in] void
		*  @return    ElementType& 末尾の要素
		*************************************************************************/
		__forceinline       ElementType& Back()        { return _data[_size - 1]; }

		/*!**********************************************************************
		*  @brief     末尾の要素をconst参照の形で返します
		*  @param[in] void
		*  @return    const ElementType& 末尾の要素
		*************************************************************************/
