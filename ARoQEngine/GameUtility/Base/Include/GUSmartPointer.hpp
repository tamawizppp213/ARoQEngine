...
/// @brief  参照カウントが0になったら自動で消去されるスマートポインタです.@n
///         SharedPointer : 参照が増えるたびに参照カウントが1増加する. 参照カウントが0になったら自動で消去される @n
///         WeakPointer   : Observerとして使用. 所有権は保持せず, リソースの破棄も行われない @n
///         UniquePointer : 所有権を一つしか持てない. 所有権を移譲しながら, 唯一の所有権を破棄するタイミングでリソースが破棄される       
/// @author Toide Yutaro
/// @date   2024_03_16
//////////////////////////////////////////////////////////////////////////////////
#pragma once
