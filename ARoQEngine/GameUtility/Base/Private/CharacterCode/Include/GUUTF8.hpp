//////////////////////////////////////////////////////////////////////////////////
///  @file   GUUTF8.hpp
///  @brief  UTF8文字コードを扱うクラス
///  @author toide
///  @date   2024/05/25 21:17:38
//////////////////////////////////////////////////////////////////////////////////
#pragma once
#ifndef GU_UTF8_HPP
#define GU_UTF8_HPP
...
namespace gu::details::string
{
	...
	*************************************************************************//**
	/*   @brief  UTF8文字コードを扱うクラス
	*****************************************************************************/
	class UTF8 : public CharacterCode
	{
	public:
		...
		*  @return    const tchar* 文字コード名
		*************************************************************************/
		__forceinline virtual const tchar* GetName() const override { return SP("UTF-8"); }
		...
		*************************************************************************/
		__forceinline virtual uint8 GetMaxByte() const override { return 6; }
		...
		*  @return    const tchar* 文字コード名
		*************************************************************************/
		virtual uint64 GetReadExtraLength(const void* buffer, const uint64 bufferSize) const override;
		...
		UTF8(const bool isBOM) : _isBOM(isBOM) {}
	...
	private:
		...
		*  @return    bool
		*************************************************************************/
		bool IsValidBOM(const uint8* input) const;
		#pragma endregion 
		...
		static constexpr uint8 BOM[] = { 0xEF, 0xBB, 0xBF };
		#pragma endregion 
